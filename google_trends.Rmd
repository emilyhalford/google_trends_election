...
voting_percentages = 
  voting_percentages %>% 
  mutate(
    data = map(state_code, ~(gtrends(keyword = "vote + voting", geo = .x, time = '2016-09-30 2020-10-26')$interest_over_time))
  )
...
voting_percentages =
  ...
  filter(
    date <= "2016-10-23" | date >= "2020-10-01" ## Change to october 4th
    )
...
#api_create(map2, filename = 'map2', sharing = 'public')
#api_create(map3, filename = 'map3', sharing = 'public')
```
